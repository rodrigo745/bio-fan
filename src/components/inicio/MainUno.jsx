    ...
    return(
        <div className="w-full  lg:h-[100%] space-x-4 flex flex-col lg:flex lg:flex-row justify-between items-center px-10 xl:px-32 2xl:px-44 lg:mt-10" >
            <div className="w-[100%] lg:w-[60%] ">
                <h3 style={{lineHeight: 1.2}} className="text-3xl lg:text-8xl roboto text-[#1d4674]  sombra-texto">ACERCA DE BIOFAN</h3>
                <p className="text-[#1d4674] text-md lg:text-3xl mt-5 open pr-20">Como profesionales del sector, nos han permitido detectar las necesidades de las empresas, brindándoles siempre soluciones con un servicio personalizado y de calidad.
                </p>
