...
export default function MainTres(){
    return(
        <div className="w-full mb-36 lg:mb-0 lg:h-screen flex flex-col-reverse lg:flex lg:flex-row lg:justify-between lg:items-center px-10 xl:px-32 2xl:px-60 mt-20 lg:mt-0">
            <div className="w-[100%] lg:w-[70%]">
               <Image src="/inicio/inicio_main_3.jpg" width={800} height={300} alt="imagen sobre 
                nuestra experiencia" />
            </div>
            <div className="w-[100%] lg:w-[30%]  justify-center mt-12  mb-20 lg:mb-0">
